...
ActiveRecord::Schema[7.0].define(version: 2022_12_28_130722) do
  create_table "consultations", force: :cascade do |t|
    ...
    t.index ["receptionist_id"], name: "index_consultations_on_receptionist_id"
  end
  ...
  add_foreign_key "consultations", "receptionists"
